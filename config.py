...
parser = argparse.ArgumentParser(description='CoPET arguments')
parser.add_argument('--pretrained-model', default='bert-base-uncased', type=str, metavar='N',
                    help='path to pretrained model')
parser.add_argument('--task', default='wiki', type=str, metavar='N',
                    help='dataset name')
parser.add_argument('--train-path', default='../data/wiki/train.txt.json', type=str, metavar='N',
                    help='path to training data')
parser.add_argument('--valid-path', default='../data/wiki/valid.txt.json', type=str, metavar='N',
                    help='path to valid data')
parser.add_argument('--model-dir', default='h../checkpoint/wiki', type=str, metavar='N',
...
parser.add_argument('--eval-model-path', default='../checkpoint/wiki/model_best.mdl', type=str, metavar='N',
